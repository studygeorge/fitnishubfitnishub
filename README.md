...
**Аутентификация:**
- JWT токены для API
- **Срок жизни токена: 365 дней** (пользователи остаются авторизованными до ручного выхода)
- Защищенные маршруты на Frontend
- Middleware для проверки прав доступа

**Важно:** Токен действителен в течение года с момента входа. Пользователь будет автоматически выйден из системы только при:
- Ручном выходе через кнопку "Выйти"
- Истечении 365 дней с момента последнего входа
- Удалении токена из localStorage браузера
